...
LDFLAGS="cloud-print-connector/lib.BuildDate=$CONNECTOR_VERSION"
CONNECTOR_DIR=$GOPATH/src/cloud-print-connector
...
echo "Running go get..."
go get -ldflags -X="$LDFLAGS" -v cloud-print-connector/...
rc=$?
if [[ $rc != 0 ]]; then
